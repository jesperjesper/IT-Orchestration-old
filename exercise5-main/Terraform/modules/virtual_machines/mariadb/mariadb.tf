...
resource "openstack_networking_floatingip_v2" "mariadb_floating_ip" {
  pool = "provider"
}

resource "openstack_compute_floatingip_associate_v2" "mariadb_floating_ip_association" {
  floating_ip = openstack_networking_floatingip_v2.mariadb_floating_ip.address
